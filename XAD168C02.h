...
#ifndef __XAD168C02_H
#define __XAD168C02_H
...
#define FOSC_RC10M          0x3FFD    //
#define FOSC_RC5M           0x3FFB    //
#define FOSC_RC2M           0x3FF9    //
...
volatile bit T0SP2               @ ((unsigned)&T0CON*8)+2;
...
// bit and bitfield definitions
volatile bit OP1IE               @ ((unsigned)&PIE1*8)+0;
volatile bit OP2IE               @ ((unsigned)&PIE1*8)+1;
volatile bit ADIE                @ ((unsigned)&PIE1*8)+2;
volatile bit LVDIE               @ ((unsigned)&PIE1*8)+3;
volatile bit PWMIE               @ ((unsigned)&PIE1*8)+4;
volatile bit BCLIE               @ ((unsigned)&PIE1*8)+5;
...
volatile bit INT0EDGE            @ ((unsigned)&PCON*8)+2;
volatile bit INT1EDGE            @ ((unsigned)&PCON*8)+3;
volatile bit INT2EDGE            @ ((unsigned)&PCON*8)+4;
...
//volatile unsigned char           red                @ 0x19A;
//red
//volatile unsigned char           green                @ 0x19B;
//green
//volatile unsigned char           blue                @ 0x19C;
//blue
#endif
